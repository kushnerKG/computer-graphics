...
public class MainFrame extends JFrame {
	 ...
	 * @param icon - file name containing icon (must be located in 'resources' subpackage relative to your implementation of MainWindow), can be null
	...
	{
		JButton tmp = createToolBarButton(menuPath);
		toolBar.add(tmp);
		return tmp;
	}
